...
describe('resource versions', () => {
  test('create: only required params', async () => {
    const responsePromise = client.nvcf.functions.versions.create('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
  ...
  test('create: required and optional params', async () => {
    const response = await client.nvcf.functions.versions.create('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      inferenceUrl: 'https://example.com',
      name: 'x',
