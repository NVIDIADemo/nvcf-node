...
describe('resource versions', () => {
  test('retrieve', async () => {
    const responsePromise = client.authorizations.functions.versions.retrieve(
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.authorizations.functions.versions.retrieve(
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test('delete', async () => {
    const responsePromise = client.authorizations.functions.versions.delete(
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test('authorize: only required params', async () => {
    const responsePromise = client.authorizations.functions.versions.authorize(
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test('authorize: required and optional params', async () => {
    const response = await client.authorizations.functions.versions.authorize(
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      {
        authorizedParties: [
