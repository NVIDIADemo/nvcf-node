...
describe('resource position', () => {
  test('retrieve', async () => {
    const responsePromise = client.queues.position.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.queues.position.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
