...
describe('resource functions', () => {
  test('list', async () => {
    const responsePromise = client.queues.functions.list('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.queues.functions.list('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
