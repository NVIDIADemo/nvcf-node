...
describe('resource assets', () => {
  test('retrieve', async () => {
    const responsePromise = client.assetManagement.assets.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('delete', async () => {
    const responsePromise = client.assetManagement.assets.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
